...
function Talk3d() {
  ...
  const outputSpeek = async (text) => {
    ...
    try {
      ...
      // let outputText =
      //   "I recommend taking over-the-counter pain relievers like acetaminophen for your headache and fever. Ensure you rest, stay hydrated, and monitor your temperature. If symptoms persist, seek medical attention";
      ...
      <div className={Stylecss.area}>
        ...
        <div style={{ display: "flex", gap: "20px" }}>
          <button onClick={() => outputSpeek(text)} className={Stylecss.btn}>
            ...
            <p>
              {loading ? "Generating..." : speak ? "Running..." : "Generate"}
            </p>
          </button>
